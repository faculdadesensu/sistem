        ...
        <div class="modal fade" id="ModalPerfil" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form id="form-perfil" method="POST" action="{{route('painel-recep.edit', $id_user)}}">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <label >Nome</label>
                                <input value="{{$user[0]->name}}" type="text" class="form-control" id="name" name="name" placeholder="Nome">
                            </div>
                            <div class="form-group">
                                <label >CPF</label>
                                <input value="{{$user[0]->cpf}}" type="text" class="form-control" id="cpf" name="cpf" placeholder="CPF">
                            </div>
                            <div class="form-group">
                                <label >Usuário</label>
                                <input value="{{$user[0]->user}}" type="text" class="form-control" id="user" name="user" placeholder="Usuário">
                            </div>
                            <div class="form-group">
                                <label >Senha</label>
                                <input value="{{$user[0]->password}}" type="text" class="form-control" id="text" name="password" placeholder="Senha">
                            </div>                    
                        </div>
    ...
    <div class="modal fade" id="relMov" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-inline" method="GET" action="{{route('relatorio.index')}}" target="_blank">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
